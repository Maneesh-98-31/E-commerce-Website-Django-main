Kalaa Bazaar(Skill Market)
====================
Features
====================
+ User Authentication & Management Using ***django-allauth***
+ Speech Recognition To Tackle Language Barrier
+ Filtering & Searching Items By Category
+ Adding & Removing Items From/To The Cart
+ Add Likes To Product
+ Add Comments To Show Interest In Learning The Skill
+ Safety Of The Seller Is Ensured By Keeping An Eye On The Comments
+ Cart Management
...
First clone this repo and go to the project root.
    ...
    $ git clone https://github.com/Vaishali-01/Kalaa-Bazaar.git
